 ...
 * 
 */
public class DukeInterlinkerRunner {
    ...
    /**
     *
     * @param configuration A Duke configuration with CSV data source.
     * @param outputWriter
     * @param dukeThreads
     */
	public DukeInterlinkerRunner(Configuration configuration, TripleWriter outputWriter, int dukeThreads) {
